...
instance Print Expr where
  prt i e = case e of
    ...
    EConstr type_ -> prPrec i 6 (concatD [doc (showString "new"), prt 0 type_])
    ...
    TEConstr type_1 type_2 -> prPrec i 6 (concatD [doc (showString "{"), prt 0 type_1, doc (showString "}"), doc (showString "new"), prt 0 type_2])
