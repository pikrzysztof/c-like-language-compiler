...
instance Print (Tree c) where
  prt _i e = case e of
    ...
    MemberDef type' items -> prPrec _i 0 (concatD [prt 0 type' , prt 0 items , doc (showString ";")])
    ...
    Incr i -> prPrec _i 0 (concatD [prt 0 i , doc (showString "++") , doc (showString ";")])
    Decr i -> prPrec _i 0 (concatD [prt 0 i , doc (showString "--") , doc (showString ";")])
